...
public Action:CEOP(Handle:timer, any:target)
{
	...
	if(EXP[target] > GetConVarInt(LvUpExp1) && Lv[target] == 0)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 1 \x03Just type \x05!rpgmenu \x03to spend status points")
	...
	if(EXP[target] > GetConVarInt(LvUpExp2) && Lv[target] == 1)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 2 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp3) && Lv[target] == 2)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 3 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp4) && Lv[target] == 3)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 4 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp5) && Lv[target] == 4)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 5 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp6) && Lv[target] == 5)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 6 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp7) && Lv[target] == 6)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 7 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp8) && Lv[target] == 7)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 8 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp9) && Lv[target] == 8)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 9 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp10) && Lv[target] == 9)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 10 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp11) && Lv[target] == 10)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 11 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp12) && Lv[target] == 11)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 12 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp13) && Lv[target] == 12)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 13 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp14) && Lv[target] == 13)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 14 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp15) && Lv[target] == 14)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 15 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp16) && Lv[target] == 15)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 16 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp17) && Lv[target] == 16)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 17 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp18) && Lv[target] == 17)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 18 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp19) && Lv[target] == 18)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 19 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp20) && Lv[target] == 19)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 20 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp21) && Lv[target] == 20)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 21 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp22) && Lv[target] == 21)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 22 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp23) && Lv[target] == 22)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 23 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp24) && Lv[target] == 23)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 24 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp25) && Lv[target] == 24)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 25 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp26) && Lv[target] == 25)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 26 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp27) && Lv[target] == 26)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 27 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp28) && Lv[target] == 27)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 28 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp29) && Lv[target] == 28)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 29 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
	...
	if(EXP[target] > GetConVarInt(LvUpExp30) && Lv[target] == 29)
	{
		...
		//레벨 업 광고
		PrintToChat(target, "\x04[LEVEL UP] \x03Level: \x05 30 \x03Just type \x05!rpgmenu \x03to spend status points")
		PrintToChat(target, "\x03Skill Point gained. Type \x05!rpgmenu \x03to upgrade Skills")
