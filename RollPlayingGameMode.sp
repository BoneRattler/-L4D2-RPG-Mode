...
new Lv[MAXPLAYERS+1]//holds players' levels
new EXP[MAXPLAYERS+1]//holds players' exp
//holds exp to be given for infected
new Handle:JocExp
new Handle:HunExp
new Handle:ChaExp
new Handle:SmoExp
...
public OnPluginStart()
{
	...
	RegConsoleCmd("ASM", AssignSkillMenu)
...
*///////////////////////////////-V-events-V-//////////////////////////////
public Action:player_first_spawn(Handle:event, String:event_name[], bool:dontBroadcast)
{
...
{
	new HealSuccessTarget = GetClientOfUserId(GetEventInt(event, "subject"))
	if(GetClientTeam(HealSuccessTarget) == TEAM_SURVIVORS && !IsFakeClient(HealSuccessTarget) && Lv[HealSuccessTarget] > 0)
	{
		if(JD[HealSuccessTarget] == 0 || JD[HealSuccessTarget] == 1 || JD[HealSuccessTarget] == 3)
		{
			SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iMaxHealth"), 100+(10*Health[HealSuccessTarget]), 4, true)
			SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iHealth"), 100+(10*Health[HealSuccessTarget]), 4, true)
		}
		
		if(JD[HealSuccessTarget] == 2)
		{
			if(TrainedHealthLv[HealSuccessTarget] == 0)
			{
				SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iMaxHealth"), 100+(10*Health[HealSuccessTarget]), 4, true)
				SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iHealth"), 100+(10*Health[HealSuccessTarget]), 4, true)
			}
			...
			if(TrainedHealthLv[HealSuccessTarget] > 0)
			{
				SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iMaxHealth"), 100+(10*Health[HealSuccessTarget])*TrainedHealthLv[HealSuccessTarget], 4, true)
				SetEntData(HealSuccessTarget, FindDataMapOffs(HealSuccessTarget, "m_iHealth"), 100+(10*Health[HealSuccessTarget])*TrainedHealthLv[HealSuccessTarget], 4, true)
			}
		}
	}
}
...
public Action:infected_hurt(Handle:event, String:event_name[], bool:dontBroadcast)
{
...
//handles exp requirement for next level
...
/*////////////////////////////////////////////////////////////////////////////////////////////////////
                             _                   
                            | |                  
  __ ___      ____ _ _ __ __| |   _____  ___ __  
 / _` \ \ /\ / / _` | '__/ _` |  / _ \ \/ / '_ \ 
| (_| |\ V  V / (_| | | | (_| | |  __/>  <| |_) |
 \__,_| \_/\_/ \__,_|_|  \__,_|  \___/_/\_\ .__/ 
                                          | |    
                                          |_|    
*/////////////////////////////////////////-V-award exp-V-////////////////////////////////////////////
//Award Exp for most Special Infected Kills
...
//award exp for common infected kills
...
/*///////////////////////////////////////////////////////////////////////////////////////////
     _        _                                          
    | |      | |                                         
 ___| |_ __ _| |_ _   _ ___   _ __ ___   ___ _ __  _   _ 
/ __| __/ _` | __| | | / __| | '_ ` _ \ / _ \ '_ \| | | |
\__ \ || (_| | |_| |_| \__ \ | | | | | |  __/ | | | |_| |
|___/\__\__,_|\__|\__,_|___/ |_| |_| |_|\___|_| |_|\__,_|
*/////////////////////////////////////////-V-status menu-V-//////////////////////////////////
...
/*////////////////////////////////////////////////////////////////////////////////////
               _                   _    _ _ _                                  
              (_)                 | |  (_) | |                                 
  __ _ ___ ___ _  __ _ _ __    ___| | ___| | |___   _ __ ___   ___ _ __  _   _ 
 / _` / __/ __| |/ _` | '_ \  / __| |/ / | | / __| | '_ ` _ \ / _ \ '_ \| | | |
| (_| \__ \__ \ | (_| | | | | \__ \   <| | | \__ \ | | | | | |  __/ | | | |_| |
 \__,_|___/___/_|\__, |_| |_| |___/_|\_\_|_|_|___/ |_| |_| |_|\___|_| |_|\__,_|
                  __/ |                                                        
                 |___/ 
*/////////////////////////////////-V-assign skills menu-V-////////////////////////////
public Action:AssignSkillMenu(client, args)
{
	if(GetClientTeam(client) == TEAM_SURVIVORS)
	{
		AssignSkillMenuFunc(client)
	}
	return Plugin_Handled
}
...
public AssignSkilMenuHandler(Handle:menu, MenuAction:action, client, itemNum)
{
	if(action == MenuAction_Select)
	{
		switch(itemNum)
...
/*////////////////////////////////////////////////////////////////////////////
      _                                            
     | |                                           
  ___| | __ _ ___ ___   _ __ ___   ___ _ __  _   _ 
 / __| |/ _` / __/ __| | '_ ` _ \ / _ \ '_ \| | | |
| (__| | (_| \__ \__ \ | | | | | |  __/ | | | |_| |
 \___|_|\__,_|___/___/ |_| |_| |_|\___|_| |_|\__,_|
*///////////////////////////////-V-class menu-V-//////////////////////////////
...
/*///////////////////////////////////////////////////////////////////////
 _        __                                   
(_)      / _|                                  
 _ _ __ | |_ ___    _ __ ___   ___ _ __  _   _ 
| | '_ \|  _/ _ \  | '_ ` _ \ / _ \ '_ \| | | |
| | | | | || (_) | | | | | | |  __/ | | | |_| |
|_|_| |_|_| \___/  |_| |_| |_|\___|_| |_|\__,_|
*//////////////////////////////////-V-info menu-V-////////////////////////
...
/*////////////////////////////////////////////////////////////////////////////////////////////
                  __ _                   __                                        
                 / _(_)                 / _|                                       
  ___ ___  _ __ | |_ _ _ __ _ __ ___   | |_ ___  _ __   _ __ ___   ___ _ __  _   _ 
 / __/ _ \| '_ \|  _| | '__| '_ ` _ \  |  _/ _ \| '__| | '_ ` _ \ / _ \ '_ \| | | |
| (_| (_) | | | | | | | |  | | | | | | | || (_) | |    | | | | | |  __/ | | | |_| |
 \___\___/|_| |_|_| |_|_|  |_| |_| |_| |_| \___/|_|    |_| |_| |_|\___|_| |_|\__,_|
*///////////////////////////////////////////-V-confirm for menu-V-////////////////////////////
...
public Action:StatusConfirmFunc(clientId)
{
	...
	{
		//Removed Obsolete references to Status Points		
		case 5: //스킬 힐링
		{
			cost = 1
		}
...
| | | / __|/ _ \ / __| |/ / | | / __|
| |_| \__ \  __/ \__ \   <| | | \__ \
 \__,_|___/\___| |___/_|\_\_|_|_|___/
 *////////////////////////////////////////////////////-V-use skills-V-///////////////////////////////////////////
...
/*//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                 _     _                         
                | |   | |                        
  ___ ___   ___ | | __| | _____      ___ __  ___ 
 / __/ _ \ / _ \| |/ _` |/ _ \ \ /\ / / '_ \/ __|
| (_| (_) | (_) | | (_| | (_) \ V  V /| | | \__ \
